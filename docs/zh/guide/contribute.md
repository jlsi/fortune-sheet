...
* 创建 [Issues](https://github.com/jlsi/fortune-sheet/issues) ，描述清楚问题
...
在 FortuneSheet 的 [Issues](https://github.com/jlsi/fortune-sheet/issues) 列表中，有很多由其他人创建的issue并未被修复，如果你感兴趣的话，可以认领这些issue。认领步骤如下：
